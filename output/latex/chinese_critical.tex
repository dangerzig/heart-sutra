...
\linenum{11} 是故空中，無\footnote{\lemma{無} \textit{wú}] \reading{无} \wit{Fangshan} throughout sections IV--VII and IX. The Fangshan stele (661 CE) consistently uses the variant form 无 for 無. This is a standard orthographic variant in Tang dynasty stone inscriptions, with no semantic difference.}色，無受想行識，\\
...
\linenum{25} 揭帝揭帝\footnote{\lemma{揭帝} \textit{jiēdì}] \reading{揭諦} \textit{jiēdì} \wit{Fangshan}. Both 帝 and 諦 are phonetic transcriptions of Sanskrit \textit{gate}; the Fangshan reading 諦 (``truth'') may be a more semantically motivated choice for a Buddhist text. Minor variants also exist in Dunhuang manuscripts. The mantra is transliterated, not translated, in all Chinese witnesses.}，波羅揭帝，波羅僧揭帝，菩提僧莎訶\footnote{\lemma{僧莎訶} \textit{sēng suōhē}] \reading{薩婆訶} \textit{sàpóhē} \wit{Fangshan}. The Fangshan reading is a more accurate transliteration of Sanskrit \textit{svāhā}; T251's 僧莎訶 appears to be corrupt. Note on \textit{oṃ}: The mantra in T251 begins directly with 揭帝 (\textit{gate}). The \textit{oṃ} found in later Sanskrit and Tibetan witnesses is a Tantric addition (9th--10th century), absent from all early Chinese witnesses, Fangshan stele (661 CE), and Hōryūji Sanskrit MS (7th--8th c.).}。\\

...
\textit{Tibetan:} \wit{D} Degé; \wit{Q} Peking; \wit{N} Narthang; \wit{H} Lhasa; \wit{J} Lithang; \wit{S} Stog.
...
\var{8}~\lemma{avidyā-kṣayo}] Uses \textit{kṣaya} where Large PP has \textit{nirodha}. ``Smoking gun'' (Nattier 1992:175--8). Chinese 盡 can mean either; back-translator chose \textit{kṣaya}. \depmark{zh}{sa} Tibetan ཟད་པ \textit{zad pa} preserves error.

\var{9}~\lemma{無智亦無得}] T251, Fangshan, Ja lack \textit{na-aprāptiḥ}. Interpolation in later witnesses.

\var{10}~\lemma{na prāptiḥ}] Late witnesses add \reading{na-aprāptiḥ} \wit{T256 Nb-e}. Tibetan མ་ཐོབ་པ preserves this interpolation.
...
Tibetan & 8th--9th c. & Translated from σ-L; preserves oṃ, \textit{na-aprāptiḥ}, \textit{zad pa} \\
